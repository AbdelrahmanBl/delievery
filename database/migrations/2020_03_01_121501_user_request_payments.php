...
class UserRequestPayments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_request_payments', function (Blueprint $table) {
            ...
            $table->decimal('minute',2,0)->default(0);
            $table->decimal('hour',2,0)->default(0);
            $table->float('fixed',      10, 2)->default(0);
            $table->float('distance',   10, 2)->default(0);
            $table->float('commision',  10, 2)->default(0);
            $table->float('commision_per',  5, 2)->default(20.00);
            ...
            $table->float('govt',        10, 2)->default(0);
            $table->float('govt_per',        5, 2)->default(0);
            $table->float('tax_marketing',        10, 2)->default(0);
            $table->float('tax_marketing_tax_per',        5, 2)->default(0);
