...
class Markerters extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('markerters', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->string('email');
            ...
            $table->double('commission_per', 5,2)->default(0);
            //$table->double('tax_marketing', 5,2)->default(0);
